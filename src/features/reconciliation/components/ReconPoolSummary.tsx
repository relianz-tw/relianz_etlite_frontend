...
/**
 * 對帳單金額／待付(收)帳總額／差額：於匯總沖帳確認階段緊鄰下方交易清單呈現，方便對照本次沖帳結果
 * （沖帳對象與拆帳結果一律由 settle/preview API 決定，見 ReconciliationView）。
 */
export default function ReconPoolSummary({ side, previewResult }: ReconPoolSummaryProps) {
