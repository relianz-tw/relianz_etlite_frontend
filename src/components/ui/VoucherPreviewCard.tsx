 ...
 */
export default function VoucherPreviewCard({
  voucherImage,
  minHeightClassName = 'min-h-[480px]',
}: {
  voucherImage: string | null;
  /** 卡片最小高度，預設 480px；手機彈窗內可傳較小值避免照片佔滿整個可視區 */
  minHeightClassName?: string;
}) {
  return (
    <div className={`flex ${minHeightClassName} w-full flex-col items-center justify-center gap-2 overflow-hidden rounded-lg border-2 border-dashed border-neutral-blue-gray/50 bg-white text-neutral-mid`}>
      {voucherImage ? (
